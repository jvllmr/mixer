...
class MixerProvider(BaseProvider):
    ...
    def positive_integer(self, max=2147483647):
        """Get a positive integer."""
        return self.random_int(0, max=max)

    def small_integer(self, min=-SMALLINT, max=SMALLINT):
        """Get a positive integer."""
        return self.random_int(min=min, max=max)

    def small_positive_integer(self, max=SMALLINT):
        """Get a positive integer."""
        return self.random_int(0, max=max)
    ...
    def json(self):
        ...
        return {self.pystr(): self.random_int() for _ in range(10)}
